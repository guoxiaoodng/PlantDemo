...
public class SoulPlanetsView extends ViewGroup implements Runnable, PlanetAdapter.OnDataSetChangeListener {
    ...
    private List<SampleItemBean> mList;
    ...
    private void addListener(View view, final SampleItemBean bean) {
        if (!view.hasOnClickListeners() && onTagClickListener != null) {
            view.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    onTagClickListener.onItemClick(SoulPlanetsView.this, v, bean);
                }
            });
        }
    }
    ...
    public void setData(List<SampleItemBean> mList) {
        this.mList = mList;
    }
    ...
    public interface OnTagClickListener {
         ...
         */
        void onItemClick(ViewGroup parent, View view, SampleItemBean bean);
    }
}